...
import type { ResearchReport } from "@/types/agent";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-6 py-8">
      {/* IDLE + LOADING: centered welcome + input */}
      {phase !== "results" && (
      ...
      {phase === "results" && report && (
        <div className="w-full max-w-3xl py-10 animate-fade-in-up">
          ...
          <div
            className={`p-5 rounded-xl border mb-6 card ${
              report.decision.verdict === "INVEST" ? "" : ""
            }`}
            role="region"
